...
public class Eight {
    ...
    public Eight(int[] x) {
	tiles = Arrays.copyOf(x, x.length);     //copies array x to array tiles and then parses through array to ID blank
    ...
    private MoveAction[] moveActions = new MoveAction[] {
	    ...
	    public boolean valid() { 
                return blankPos > LENGTH-1;
            }
	    public void move() { tiles[blankPos] = tiles[blankPos-LENGTH]; 
            blankPos -= LENGTH; tiles[blankPos] = 0;
            }
	},
        new MoveAction() { // down
	    ...
	    public void move() { tiles[blankPos] = tiles[blankPos-1]; 
            blankPos -= 1; tiles[blankPos] = 0;
            }
	},
